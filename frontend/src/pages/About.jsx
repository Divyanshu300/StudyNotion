    ...
    <div>
        ...
        <section className='bg-richblack-700'>
            <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent justify-between gap-10 text-center text-white'>
                ...
                <div className='absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 lg:gap-5 gap-3'>
        ...
        <section className='border-b border-richblack-700'>
            <div className='mx-auto text-richblack-500 flex max-w-maxContent flex-col justify-between gap-10'>
        ...
        <section>
            <div className='mx-auto flex flex-col text-richblack-500 w-11/12 max-w-maxContent justify-between gap-10'>
                {/* Founding story waala div */}
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    {/* Founding story left box */}
                    <div className='mt-24 flex lg:w-[50%] flex-col gap-10'>
                        <h1 className='bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]'>
                            Our Founding Story
                        </h1>

                        <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            Our e-learning platform was vorn out of a shared vision and passion for
                            transforming education. It all began with a group of educators, teachnologist, and 
                        ...
                        <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            As experience educators ourselvesd, we witnessed firsthand the limitations and 
                            challenges of traditional education systems. We believed that education should not 
                            be confined to the walls of the classroom or restricted by geographical boundaries.
                            We envisioned a platform that couild bridege these gaps and empower individuals from 
                ...
                {/* Vission and Mission waala parent div */}
                <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                    ...
                    <div className='my-24 flex flex-col lg:w-[40%] gap-10'>
                        ...
                        <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                            With this vision in mind, we set on a journey to create an e-learning 
                            platform that would revolutionize the way people learn. Our team of dedicated
                            experts worked tirelessly to develop a robust and intutive platform that combines
                    ...
                    <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                        ...
                        <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                            ...
                            vibrant comunity of learners, where individuals can connnect, collaborate, and
