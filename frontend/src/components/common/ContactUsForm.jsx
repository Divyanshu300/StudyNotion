      ...
      <div>
        ...
        {/* email */}
          ...
          <div className='flex flex-col gap-2 mb-7'>
            ...
            {
              errors.phoneNo && (
                <span className='-mt-1 taet-[12px] text-yellow-100'>
          ...
          <div className='flex flex-col gap-2 mb-7'>
            ...
            {
              errors.message && (
                <span className='-mt-1 text-[12px] text-tellow-100'>
          ...
          <button 
            disabled={loading}
            type='submit'
            className={`rounded-md bg-yellow-50 text-center px-6 py-3 text-[13px] font-bold text-black
            shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]
            ${
              !loading &&
              "transition-all duration-200 hover:scale-95 hover:shadow-none"
            } disabled:bg-richblack-500 sm:text-[16px] w-full`}>
            Send Message
          </button>
      </div>
    </form>
