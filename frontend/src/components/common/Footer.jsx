    ...
    <div className='bg-richblack-800'>
        <div className='flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14'>
            <div className='border-b w-[100%] flex flex-col lg:flex-row border-richblack-700'>
                {/* Section 1 */}
                <div className='lg:w-[50%] flex flex-row flex-wrap justify-between lg:border-r border-richblack-700 pl-3 lg:pr-5 gap-3'>
                    ...
                    <div className='w-[48%] lg:w-[30%] mb-7 lg:pl-0'>
                        ...
                        <div className='text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-all mt-2'>
        ...
        <div className='flex flex-row text-richblack-400 items-center justify-between w-11/12 max-w-maxContent mx-auto pb-14 text-sm'>
            {/* Section 1 */}
                ...
                <div className='flex flex-row'>
                    {
                        BottomFooter.map((element , index) => (
                            ...
                            className={`${
                                ...
                                ""
                                : "broder-r border-richblack-700 cursor-pointer hover:text-richblack-50 transition-all duration-200"
                            } px-3 `}>
                                <Link to={element.split(" ").join("-").toLowerCase()}>
                                    {element}
                                </Link>
